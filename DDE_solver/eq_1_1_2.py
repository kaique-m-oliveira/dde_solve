...
if __name__ == "__main__":
    ...
    # Unpack times and solutions from history_data for consistency with plotting and error calculation
    ...
    # --- Save the plot to a file (consistent with previous instruction) ---
    plt.savefig("dde_solution_plot.png")
    # plt.show() # This line is intentionally removed/commented out
