...
_BETA = 0.01  # Infection rate (S to I)
_MU = 0.1  # Natural death rate
_P = 0  # Proportion of A that becomes infected (direct infection)
...
if __name__ == "__main__":
    ...
    plt.grid(True)
    plt.yscale("linear")
    plt.savefig(f"figure_(2)_hopefully_tau_{_TAU}.png")  # Save with tau in filename
    plt.show()
